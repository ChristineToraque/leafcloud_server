...
def build_model_v11():
    ...
    # ==========================================
    # Stop gradients at the outputs of backbones to prevent regression loss
    # from leaking back and corrupting the classification feature extractors.
    x_stopped = StopGradient()(x)
    s_stopped = StopGradient()(s)
    clf_output_stopped = StopGradient()(clf_output)

    # Independent fusion path specifically optimized for regression tracking
